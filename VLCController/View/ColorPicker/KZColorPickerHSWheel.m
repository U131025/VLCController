...
{
    MyLog(@"current Color:%@", [UIColor hexFromUIColor:currentColor]);
    RGBType rgb = RGBTypeMake((CGColorGetComponents(currentColor.CGColor))[0], (CGColorGetComponents(currentColor.CGColor))[1],(CGColorGetComponents(currentColor.CGColor))[2]);
    self.currentHSV = RGB_to_HSV(rgb);
}
