...
//        CGFloat offsetY = IS_IOS7_OR_LATER ? 64.0f : 0;
        _currentRootView.frame = (CGRect){frame.origin.x, NavBarHeight, frame.size.width, frame.size.height};
    }];
...
//    NSLog(@"current text %@ len %lu,prelen %d",text,(unsigned long)[text length],preLength);
